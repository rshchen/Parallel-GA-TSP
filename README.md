...
### 1. 尋優精準度分析 (Optimality & Accuracy)
針對不同規模的經典測項，進行 10 次獨立實驗統計。結果顯示，本系統在各規模下均能穩定收斂至極低的誤差範圍。

| Instance | 城市規模 (n) | TSPLIB 最優解 | 實測最佳 (Best) | 誤差 (Gap %) | 穩定度 (CV %) |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **berlin52** | 52 | 7542 | 7746.86 | **2.72%** | 2.11% |
| **st70** | 70 | 675 | 682.66 | **1.13%** | 2.01% |
| **ch150** | 150 | 6528 | 6825.46 | **4.56%** | 1.85% |

*註：Gap 計算參考自 TSPLIB 官方公佈之最佳已知解 (Best Known Solution)；CV (變異係數) 反映演算法在隨機種子變動下的穩定性。*
